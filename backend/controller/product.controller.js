...
export const getFeaturedProducts=async(req,res)=>{
    try {
        ...
        if(!featuredProducts)
        {
            res.status(400).json({message:"No featured product found"});
        }
...
export const deleteProduct = async(req,res)=>{
    try {
        ...
        condsole.log("Error iin deleteProduct controller",error.message);
        res.status(500).json({message:"server error",error:error.message});
    }
};
...
export const updateFeaturedProductsCache=async(req,res)=>{
    try {
        ...
        console.log("Error in update cache function controller");
    }
};